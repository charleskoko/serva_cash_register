...
class PriceEntryPopUp extends StatefulWidget {
  final double curvedValue;
  final Animation<double> a1;
  final Map<String, dynamic> article;
  PriceEntryPopUp(this.curvedValue, this.a1, this.article);

  @override
  _PriceEntryPopUpState createState() => _PriceEntryPopUpState();
}

class _PriceEntryPopUpState extends State<PriceEntryPopUp> {
  String cashFund;
                          ...
                          TextButton(
                              onPressed: () {
                                BlocProvider.of<ListingCubit>(context)
                                    .addArticleToListing(
                                        widget.article['product'],
                                        article: widget.article,
                                        price: double.parse(cashFund));
